...
\label{sec:org658ea24}
\begin{frame}[label={sec:org62c9196}]{Brief State Of The Art}
\end{frame}
\begin{frame}[label={sec:orgcea059b}]{Problem Description}
\begin{center}
\includegraphics[width=0.55\textwidth]{./img/visit.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgfd1698c}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgde6409a}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org02d72ef}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:org1abb528}
\begin{frame}[label={sec:org1fecaff}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb3068d7}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org77c141a}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:org882077f}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgbbf9dfd}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org02167a4}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}
\begin{subfigure}[t]{\textwidth}
\centering
    \includegraphics[width=\textwidth]{img/milp-pap/charge-milp}
\end{subfigure}
\begin{subfigure}[t]{\textwidth}
\centering
    \includegraphics[width=\textwidth]{img/milp-pap/charge-qin}
\end{subfigure}
\end{figure}
\end{column}
...
\label{sec:orgda6f075}
\begin{frame}[label={sec:org8af30af}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}\label{org99ea8cf}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{./img/score-convergence.pdf}
\end{center}
\end{column}
...
\begin{frame}[label={sec:org7c76ddd}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4b0a523}]{Acceptance Criteria\textsuperscript{\ref{org99ea8cf}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org5041555}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga6c19e8}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org837830e}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org814ff73}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:orge9db199}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:orgba99f42}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
\item Qin heavily utilizes fast charger
\item PAP has more focus on slow chargers, but utilizes fast charger more readily than SA
\end{itemize}
}
...
\begin{subfigure}[t]{\textwidth}
\centering
    \includegraphics[width=0.75\textwidth]{img/sa-pap-paper-good/schedule-qin}
\end{subfigure}
\end{figure}
\end{column}
...
\item Fast chargers used sparingly
\end{itemize}
}
...
\begin{frame}[label={sec:org362b147}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org2b264be}]{Energy}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org905a0fb}]{Energy}
\begin{figure}[htpb]
\centering
...
\label{sec:org7476bce}

\begin{frame}[label={sec:org9cf97c1}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4400209}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org7fe5df0}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
...
\appendix
\begin{frame}[label={sec:orga0c4e54}]{Appendix}
\end{frame}

\begin{frame}[label={sec:org36a30e0}]{Supplemental Material}
\end{frame}
\begin{frame}[label={sec:org56caabd}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org2c164ca}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:org8bdf2cb}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org37f92b3}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orge946684}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orga5f4b0d}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgef0f2af}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orge343fa2}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:orgb4d1605}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org80456b4}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgee7a0b7}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:orge902e52}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
\alert{Model} & \alert{Execution Time} [s] & \alert{Iteration} [s]\\[0pt]
\hline
...
\begin{frame}[label={sec:org9531c96}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org4461c51}]{Schedule}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org78ec94f}]{Power}
\begin{figure}[htpb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org1e2c068}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org41db234}]{What Happened?}
\end{frame}
\begin{frame}[label={sec:orgdd81232}]{How To Resolve This Problem?}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org356ca1b}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
