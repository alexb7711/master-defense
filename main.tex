...
\label{sec:orgf1da386}
\begin{frame}[label={sec:org2b3d2e8}]{Brief State Of The Art}
\begin{center}
...
\begin{frame}[label={sec:org11dddc4}]{Problem Description}
\begin{center}
\includegraphics[width=0.55\textwidth]{./img/visit.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org01e8844}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga3000d4}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orgc4d27a9}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:org0f1f5c2}
\begin{frame}[label={sec:org0598815}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4387ce6}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org792f50c}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:org6c26057}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:orgf7774d8}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org3fd74d1}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgeffd101}
\begin{frame}[label={sec:orgdbfc390}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org6eaef51}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org2cb9add}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:orgd658e01}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org80ac80a}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org43daafa}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org289d44e}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:orgffab53c}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\begin{tabular}{lr}
...
\begin{frame}[label={sec:orgb8ca30f}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org617ca6a}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgbbfe2a1}]{Energy and SOC}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3479796}]{Energy}
\begin{figure}[htpb]
\centering
...
\label{sec:org1eda9cb}
\begin{frame}[label={sec:orga00a7a0}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd6ed2ee}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:orgfb4e3d2}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\appendix
\begin{frame}[label={sec:org205d8b0}]{Appendix}
\end{frame}

\begin{frame}[label={sec:orgbcb76d2}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org174cfbf}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:org3c36955}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org122dc91}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgc63b88f}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org1f77a5c}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org389b883}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgccedc8f}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:org8e6e36a}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org547567c}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgdb9dcf6}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:orgf2d64a0}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org42f24aa}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org98c7d96}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org6bd5812}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8d640e3}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgaa68091}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org7a28470}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:orgfff1ee4}]{References}
