...
\label{sec:orgbcbd46a}
\begin{frame}[label={sec:orgc718da3}]{Brief State Of The Art}
\end{frame}
\begin{frame}[label={sec:orgdd87fe6}]{Problem Description}
\begin{center}
\includegraphics[width=0.55\textwidth]{./img/visit.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6af67ca}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org7b9581c}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org30b1876}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:org79eef5d}
\begin{frame}[label={sec:orgf1f1f95}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org35aede3}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org2545ce2}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:orga5f7155}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8f215f7}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org57dc09d}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}
...
\label{sec:orgebaa259}
\begin{frame}[label={sec:orgef4a4a6}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org034e75b}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org49b725a}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org9becbef}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org52a30b9}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4adeace}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:orgc794c3a}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org1f2f34a}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org5f3b5e5}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orgd281ad5}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orga6ce79f}]{Energy}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org927da44}]{Energy}
\begin{figure}[htpb]
\centering
...
\label{sec:org0fe4240}

\begin{frame}[label={sec:org90ca1a8}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4d41144}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org0f59ac7}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
...
\appendix
\begin{frame}[label={sec:org67368b8}]{Appendix}
\end{frame}

\begin{frame}[label={sec:orgca7759f}]{Supplemental Material}
\end{frame}
\begin{frame}[label={sec:org109b3c4}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org392f412}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:orgbbb4957}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgbbb0f61}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgd57560e}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org328c547}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org3aae187}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org514b714}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:orgeae19bf}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org94228cc}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgf13f624}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:org7c5752a}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
\alert{Model} & \alert{Execution Time} [s] & \alert{Iteration} [s]\\[0pt]
\hline
...
\begin{frame}[label={sec:org1e70931}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgad84fa9}]{Schedule}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgf791e5a}]{Power}
\begin{figure}[htpb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org576f443}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org907797b}]{What Happened?}
\end{frame}
\begin{frame}[label={sec:orgfec81dd}]{How To Resolve This Problem?}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgd8986db}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
