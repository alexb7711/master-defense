...
\label{sec:org97b8d56}
\begin{frame}[label={sec:org7de1fc4}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:orgbc62726}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgac59c07}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgbe10ffd}]{The Berth Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd691df5}]{The Berth Allocation Problem}
\begin{itemize}
...
\begin{frame}[label={sec:org2cd9b13}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:org611bc55}
\begin{frame}[label={sec:orgab617ca}]{Requirements For BEB Implementation}
\begin{itemize}
...
\begin{frame}[label={sec:org4054ba1}]{Objective Function}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org69dfc82}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3c7b989}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Used to ensure that individual rectangles do not overlap
...
\begin{frame}[label={sec:orgd2b2d3b}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org292f257}]{Linear Battery Dynamic Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgcd1cdef}]{Bilinear Linearization Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org6ee4366}]{Charging Queue Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9000279}]{Results}
\begin{itemize}
...
\begin{frame}[label={sec:org7680282}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org3d3c6f8}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org432eaf2}]{Results}
\begin{figure}[htpb]
\centering
...
\label{sec:org476ff7c}
\begin{frame}[label={sec:orgb03423e}]{Simulated Annealing}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6f8f89c}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4fbca9b}]{Acceptance Criteria}
\begin{equation}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org1427bbd}]{Generation Mechanisms - Primitive Functions}
\begin{itemize}
...
\begin{frame}[label={sec:org6f972c8}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org97bf6ff}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orge7f1ec1}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org40d9424}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org47c1cbd}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org307ad93}]{Generation Mechanisms - Wrapper Functions}
\begin{itemize}
...
\begin{frame}[label={sec:org020c489}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org5429b8e}]{Perturb Schedule}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgace8e46}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org4f4de93}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\label{sec:orgfb4f70d}
\begin{frame}[label={sec:org49bef64}]{Introduction}
\begin{itemize}
\item Why even consider this?
\item Why use SA
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf2038af}]{Non-Linear Battery Dynamics Model}
\begin{itemize}
\item Show function
\item Show plots
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org364998c}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
