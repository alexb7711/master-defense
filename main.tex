...
\label{sec:org6513b23}
\begin{frame}[label={sec:orgcb8a04d}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:orge96cdc1}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:org2f446ed}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org88309f1}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org4772795}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:org620b3a5}
\begin{frame}[label={sec:org824043f}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org0f63675}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orgc52a803}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:org1b71715}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:org6224a30}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org0bdd2a5}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgfe70491}
\begin{frame}[label={sec:org29f71e4}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org6259bea}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc8cdd19}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:orge1346f8}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga740fea}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org233d9e8}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org05fde0e}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org28269bb}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\begin{tabular}{lr}
...
\begin{frame}[label={sec:orgceb74bb}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orga62979b}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org8a85dca}]{Energy and SOC}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9cc05a3}]{Energy}
\begin{columns}
...
\label{sec:org0467c50}
\begin{frame}[label={sec:org623e62a}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd5034c5}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:orgffba4c7}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\appendix
\begin{frame}[label={sec:orgd591243}]{Appendix}
\end{frame}

\begin{frame}[label={sec:orgd7ad6be}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgcc914e5}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:org1215a99}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org792a4a1}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgd40c961}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org13994d0}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org4b776c1}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org40c2a16}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:org02b08cc}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orge50cbe7}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgdfeab6a}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:orge33b385}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:orgdd1bb7b}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1f85608}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org79835f4}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8bbe365}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org80d772a}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgd92d74b}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org3ea4642}]{References}
