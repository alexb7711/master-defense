...
\setbeamercolor{block title alerted}{fg=Maroon,bg=red!60}
\setbeamercolor{block body alerted}{fg=black,bg=red!40}
\setbeamercolor{alerted text}{fg=black}

\setbeamercolor{block title}{fg=Blue,bg=SkyBlue!70}
\setbeamercolor{block body}{fg=black,bg=SkyBlue!50}
\setbeamercolor{itemize item}{fg=black}
\setbeamercolor{itemize subitem}{fg=black}

\section{Introduction}
\label{sec:org08404cf}
\begin{frame}[label={sec:org49497e5}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:org4cd7c45}]{Overall Objective}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge50c517}]{Model Objectives - BPAP}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org0970242}]{Model Objectives - Linear SA}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org7c8f3ee}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:org688804a}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd315e69}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orga4d560d}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org35c4a36}
\begin{frame}[label={sec:org7f31c39}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf21268f}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orgf122e9c}]{Queuing Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\colorboxed{blue}{
...
\begin{frame}[label={sec:orgd10dcd9}]{Parameters}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\begin{tabular}{l|l}
...
\begin{frame}[label={sec:orgc6f7735}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgb1eef04}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org96fd1f8}
\begin{frame}[label={sec:org082ec93}]{Objective Function And Constraints}
\begin{equation*}
...
\begin{frame}[label={sec:orgd3dffae}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org253b685}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orgdf850f7}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orga6ea8cd}]{SOC and Energy}
\begin{columns}
...
\begin{frame}[label={sec:org38a4963}]{Scores and Energy}
\begin{columns}
...
\section{{\bfseries\sffamily TODO} Summary and Questions}
\label{sec:org1265bd4}
\begin{frame}[label={sec:org70abdb2}]{Summary}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgd738997}]{Publications}
\begin{center}
\includegraphics[width=.9\linewidth]{./img/pub.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org249078e}]{}
\centering
\Huge Questions?
\end{frame}

\appendix
\begin{frame}[label={sec:org1d7e1d6}]{}
\centering
\Huge Appendix
\end{frame}

\begin{frame}[label={sec:org4ec96c0}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgee86735}]{}
\centering
\Huge SA with Non-Linear Battery Dynamics
\end{frame}

\begin{frame}[label={sec:org5c2bf2e}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org645ddb7}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:orgc96e3fc}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org9346351}]{}
\centering
\Huge Simulated Annealing
\end{frame}

\begin{frame}[label={sec:org3d12c47}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3d1499a}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org39b4492}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org959d75d}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org59880ed}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5fb63cb}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org1f97447}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orga0e9e52}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgb529a48}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org8a431bc}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org12e84a6}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org75d57cf}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:org1b3d3ef}]{}
\centering
\Huge Thesis Results
\end{frame}

\begin{frame}[label={sec:orgbe269a9}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org7aa6a0e}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgc347ccb}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orge7345fe}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0bf7a4e}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgfc7e030}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgcb61e12}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:orgfd6cbbe}]{References}
