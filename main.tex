...
\label{sec:org1e86135}
\begin{frame}[label={sec:orge21c1a7}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:orgf5a179d}]{Overall Objective}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orga374140}]{Model Objectives - BPAP}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org6c50ef5}]{Model Objectives - Linear SA}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orga2601b4}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:org4f17499}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org21019db}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org8f6b084}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:orgbd02f02}
\begin{frame}[label={sec:orgb080d3f}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdb8e7e5}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org41764ec}]{Queuing Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\colorboxed{blue}{
...
\begin{frame}[label={sec:org9283f16}]{Parameters}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\begin{tabular}{l|l}
...
\begin{frame}[label={sec:org3f9dc66}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org59890fd}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgc3b414c}
\begin{frame}[label={sec:orga508f16}]{Objective Function And Constraints}
\begin{equation*}
...
\begin{frame}[label={sec:org32ee7de}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgdfcf765}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org5c9bf83}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org9770c5d}]{SOC and Energy}
\begin{columns}
...
\begin{frame}[label={sec:org2162866}]{Scores and Energy}
\begin{columns}
...
\label{sec:orgb71af46}
\begin{frame}[label={sec:org2a116e4}]{Summary}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgd370c46}]{Publications}
\end{frame}
\begin{frame}[label={sec:org9f460ea}]{}
\centering
\Huge Questions?
\end{frame}

\appendix
\begin{frame}[label={sec:org8b6ab93}]{}
\centering
\Huge Appendix
\end{frame}

\begin{frame}[label={sec:orgdc1a1e0}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgc9a7f7b}]{}
\centering
\Huge SA with Non-Linear Battery Dynamics
\end{frame}

\begin{frame}[label={sec:orga7fd606}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgab0ce3d}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org901e645}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org3efb95a}]{}
\centering
\Huge Simulated Annealing
\end{frame}

\begin{frame}[label={sec:org6b90f0a}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org88e0c2e}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org6993b74}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org11709e8}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb20c472}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8dd8a2}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org8dd2ade}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org99668ce}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org9d215c1}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org7cef6cb}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgadccb8e}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgbb8a779}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:org5462657}]{}
\centering
\Huge Thesis Results
\end{frame}

\begin{frame}[label={sec:org064c680}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org57e08dc}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orga92cf7e}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org673e8d2}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org171161c}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org4996a35}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgb7d0431}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org1083250}]{References}
