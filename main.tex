...
\label{sec:orgdfb3028}
\begin{frame}[label={sec:org4b52731}]{}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:org1580856}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:orgaa975ed}]{Overall Objective}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Minimize cost
...
\begin{frame}[label={sec:org109e943}]{Model Objectives - BPAP}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org84ae098}]{Model Objectives - Linear SA}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org680d532}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:org0157201}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6d87f2d}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orgb2f6b1a}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org07cebf7}
\begin{frame}[label={sec:org4d5d0cf}]{}
\begin{block}{}
\begin{center}
...
\begin{frame}[label={sec:org7faf98e}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge38e6e4}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orge156cdc}]{Queuing Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\colorboxed{blue}{
...
\begin{frame}[label={sec:org6a657fc}]{Parameters}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\begin{tabular}{l|l}
...
\begin{frame}[label={sec:orgea1348c}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgdbe88a7}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org106c9a1}
\begin{frame}[label={sec:org968d0b2}]{}
\begin{block}{}
\begin{center}
...
\begin{frame}[label={sec:orgbf1f80f}]{Objective Function And Constraints}
\begin{equation*}
...
\begin{frame}[label={sec:org9cd49e8}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org8dabe1c}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org6c0ec61}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org7475348}]{SOC and Energy}
\begin{columns}
...
\begin{frame}[label={sec:org4dd2fc8}]{Scores and Energy}
\begin{columns}
...
\label{sec:org440bb1c}
\begin{frame}[label={sec:org3a8860e}]{}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:orge647b26}]{Summary}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org02f30a5}]{Publications}
\begin{center}
\includegraphics[width=.9\linewidth]{./img/pub.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgee21447}]{}
\centering
\Huge Questions?
\end{frame}

\appendix
\begin{frame}[label={sec:org8aa2896}]{}
\centering
\Huge Appendix
\end{frame}

\begin{frame}[label={sec:org209f487}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgc5c1fa6}]{}
\centering
\Huge SA with Non-Linear Battery Dynamics
\end{frame}

\begin{frame}[label={sec:org9c93f73}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4311de2}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org5211187}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orge4356a3}]{}
\centering
\Huge Simulated Annealing
\end{frame}

\begin{frame}[label={sec:orgd0b9f86}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5c29fe8}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8e9bd39}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:orgd179147}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgfb5c8bc}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd51a2c1}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org3ca45da}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgf22fe72}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgf95bece}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org748087a}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgfe7645d}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgadb5323}]{Charge Schedule Perturbation}
\begin{algorithm}[H]
\tiny
...
\begin{frame}[label={sec:org5437917}]{}
\centering
\Huge Thesis Results
\end{frame}

\begin{frame}[label={sec:org121b218}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:orge6f07e2}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org3c33cb2}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center} {\small \underline{Before}}\end{center}
...
\begin{frame}[label={sec:org62f3004}]{Energy}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center} {\small \underline{Before}}\end{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgfeb5825}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org94f2e02}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orge5b9c79}]{References}
