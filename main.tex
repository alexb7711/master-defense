...
\begin{frame}[label={sec:org588961c}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org1218d5e}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:org15559dc}
\begin{frame}[label={sec:org275ffff}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org960560e}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org9a32241}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org73f0c22}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org6018501}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org45d26bc}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org580b80f}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org5737853}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:orgedb0dba}]{Supplemental Material}
\end{frame}
\begin{frame}[label={sec:org1ae6238}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgafbacaa}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:orgd15bd5a}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org5921a16}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org98f03bb}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org9afe767}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orge2c2eba}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org2ec63de}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:org5b0d514}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org4e7ea0b}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgd5bcdca}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:orgc82f6b9}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
\alert{Model} & \alert{Execution Time} [s] & \alert{Iteration} [s]\\[0pt]
\hline
...
\begin{frame}[label={sec:org1508f08}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
