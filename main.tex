...
\label{sec:org5e92009}
\begin{frame}[label={sec:org8c90149}]{}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:org3dcc3b7}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:org4fd392a}]{Overall Objective}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org9084e6a}]{The Berth Allocation Problem}
\begin{columns}
...
\label{sec:org60a41e6}
\begin{frame}[label={sec:orga0a2407}]{}
\begin{block}{}
\begin{center}
...
\begin{frame}[label={sec:orgeec7860}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org1e10140}]{Queuing Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\colorboxed{blue}{
...
\begin{frame}[label={sec:org5553e85}]{Parameters}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\begin{tabular}{l|l}
...
\begin{frame}[label={sec:org85a3de2}]{Objective Function And Constraints}
\begin{equation*}
...
\begin{frame}[label={sec:org3587d50}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1947dbb}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org2930dc1}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1d826a3}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org77be85a}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org168b58b}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org0862ac9}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgdd36aa6}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgc3ed4a7}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org1cab7cf}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgdb15f24}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org7712ec4}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgbdb8841}]{Charge Schedule Perturbation}
\begin{algorithm}[H]
\tiny
...
\begin{frame}[label={sec:orgebe24da}]{}
\centering
\Huge Thesis Results
\end{frame}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3c8cacd}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
