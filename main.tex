...
\begin{frame}[label={sec:orgfdffe62}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orgc4c088d}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:orga073b32}
\begin{frame}[label={sec:org3fa4142}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orged98b48}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orgfd9ceca}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:orgc0a2ff0}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:orga7c83db}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5c0dd72}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org3fb7fa3}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org49e705a}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf1da6e}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org4614122}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgb3ff41b}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org3d12d06}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org6981931}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:org916b241}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgd07b123}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org9ca3b55}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orga354d18}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orge598756}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org8b43e62}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:orgcf67dd2}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org051e923}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orge5d73f1}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:orgb374602}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org17f9468}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgebecbd1}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgd3e6db2}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgffc0104}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgfea1ff5}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1804f0c}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org1639545}]{References}
