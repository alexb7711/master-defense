...
\label{sec:org6fa919c}
\begin{frame}[label={sec:org79c8a10}]{Problem Description}
\begin{itemize}
\item Introduce the problem
\item What are we trying to solve
\item Mini literature review
\end{itemize}
\end{frame}

\begin{frame}[label={sec:org0adb5a6}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:org83572c8}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1d5ef15}]{The Berth Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org534b0e3}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orgb9e282d}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:org4ef6c5d}
\begin{frame}[label={sec:orgb5cbfa3}]{Requirements For BEB Implementation}
\begin{itemize}
...
\begin{frame}[label={sec:org42aabbe}]{Objective Function}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org9c06f2a}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org605c470}]{Results}
\begin{itemize}
...
\begin{frame}[label={sec:org9cea1c1}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org7f4fb3a}]{Power And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\label{sec:org62fa03b}
\begin{frame}[label={sec:org40ae696}]{Simulated Annealing}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc1351ba}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org55d84f3}]{Acceptance Criteria}
\begin{equation}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org50da524}]{Generation Mechanisms - Primitive Functions}
\begin{itemize}
...
\begin{frame}[label={sec:orgdc311bc}]{Generation Mechanisms - Wrapper Functions}
\begin{itemize}
...
\begin{frame}[label={sec:orga019d80}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:orgd738edf}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org425e054}]{Results}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org56ec6cb}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org6926b3d}]{Power}
\begin{figure}[htpb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgdd88799}]{Energy}
\begin{figure}[htpb]
\centering
...
\label{sec:org2e653b3}
\begin{frame}[label={sec:org27f28b3}]{Introduction}
\begin{itemize}
\item Higher fidelity in approximating charge at high SOC
\item Implemented in SA for simplicity
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6300eb2}]{Non-Linear Battery Dynamics Model}
\begin{itemize}
\item Show function
\item Show plots
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org54ab651}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
