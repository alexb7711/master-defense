...
\label{sec:orga5f6cdb}
\begin{frame}[label={sec:org05c6076}]{Brief State Of The Art}
\begin{center}
...
\begin{frame}[label={sec:org200433d}]{Problem Description}
\begin{center}
\includegraphics[width=0.55\textwidth]{./img/visit.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6b2bd1a}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org774dd32}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orge8d9d36}]{The Position Allocation Problem}
\begin{columns}
...
\label{sec:org6ea0612}
\begin{frame}[label={sec:orgde4b3f4}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb9cc6a6}]{Constraints}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orgf7b72f5}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:orgf88e994}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:org7db9d26}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgcaa2d49}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:org3a2e156}
\begin{frame}[label={sec:org65dbb2b}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1c03d27}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5c073c2}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:orgd285e89}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org01eaef7}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8ee2cd3}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:orgb31418b}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org4f4cfeb}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org40c535d}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orgc271bae}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org35a6324}]{Energy and SOC}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org5663f53}]{Energy}
\begin{figure}[htpb]
\centering
...
\label{sec:org525ca73}
\begin{frame}[label={sec:org78de017}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgf15198b}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org06b2966}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\appendix
\begin{frame}[label={sec:org1cedc62}]{Appendix}
\end{frame}

\begin{frame}[label={sec:org00e5999}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orgda41b0c}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:org984dbdb}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgea262c9}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgd2600ed}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org4dee85a}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org99ec105}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgba08a0e}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:org54c2271}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org7ee094c}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:orgefae48e}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:org15534d0}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
\alert{Model} & \alert{Execution Time} [s] & \alert{Iteration} [s]\\[0pt]
\hline
...
\begin{frame}[label={sec:orgc5fa929}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org2999426}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org647350e}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4648f42}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org83406b1}]{What Happened?}
\end{frame}
\begin{frame}[label={sec:orgc72b0fb}]{How To Resolve This Problem?}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgbd9dfaf}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org8282fd0}]{References}
