...
\label{sec:orgb1847b3}
\begin{frame}[label={sec:orgc8244a9}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:org898d0f5}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org38a85ec}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org641d52c}]{The Berth Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org8b28e06}]{The Berth Allocation Problem}
\begin{itemize}
...
\begin{frame}[label={sec:org16fdfc9}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:org1782abe}
\begin{frame}[label={sec:orgb3c1fec}]{Requirements For BEB Implementation}
\begin{itemize}
...
\begin{frame}[label={sec:orgc9e110e}]{Objective Function}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:orgccdca7e}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orge08976d}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Used to ensure that individual rectangles do not overlap
...
\begin{frame}[label={sec:org667bb36}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4b73d13}]{Linear Battery Dynamic Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb3ffa70}]{Bilinear Linearization Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org32b1257}]{Charging Queue Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdc2d8ee}]{Results}
\begin{itemize}
...
\begin{frame}[label={sec:orgbcf0e85}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org861ef03}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgc836fee}]{Results}
\begin{figure}[htpb]
\centering
...
\label{sec:org7aad8ab}
\begin{frame}[label={sec:orgee1e52b}]{Simulated Annealing}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc3cb6f2}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org06ada4a}]{Acceptance Criteria}
\begin{equation}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org7e570b4}]{Generation Mechanisms - Primitive Functions}
\begin{itemize}
...
\begin{frame}[label={sec:org00a452d}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org9c79581}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org151cd61}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org3514f8f}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orge8576a8}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgbdc5fb3}]{Generation Mechanisms - Wrapper Functions}
\begin{itemize}
...
\begin{frame}[label={sec:orgf113630}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org55cf6ae}]{Perturb Schedule}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:org4c2f942}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org3269fbe}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:orgd92d20a}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\label{sec:org9f1efe7}
\begin{frame}[label={sec:org3044a71}]{Introduction}
\begin{itemize}
\item Why even consider this?
\item Why use SA
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org000f74c}]{Non-Linear Battery Dynamics Model}
\begin{itemize}
\item Show function
\item Show plots
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgaa4c080}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
