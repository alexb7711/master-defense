...
\label{sec:orgd4c7fd1}
\begin{frame}[label={sec:orge7733d5}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:org0d965da}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:orga3d0edf}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb97ddd1}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:org4b64b7b}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:orgd3e1961}
\begin{frame}[label={sec:org79e0819}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org14fd950}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org1108274}]{Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\begin{array}{l}
...
\begin{frame}[label={sec:org303c742}]{Parameters}
\begin{columns}
...
\begin{frame}[label={sec:org010ca1e}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgf30d668}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgc9853e9}
\begin{frame}[label={sec:org3d24407}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgdd8039f}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org57bc96f}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org005cc3b}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org855d207}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgaf9a082}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:org1350520}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:org55ca41c}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\begin{tabular}{lr}
...
\begin{frame}[label={sec:org260846c}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:orgc66e40c}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgb093fb6}]{SOC and Energy}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgb00cdd3}]{Scores and Energy}
\begin{columns}
...
\label{sec:orgac00f55}
\begin{frame}[label={sec:orgaf2e9d0}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org3023792}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org201e346}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org18c9fbd}]{\center Questions?}
\end{frame}
\appendix
\begin{frame}[label={sec:org4a0102f}]{Appendix}
\end{frame}

\begin{frame}[label={sec:orgff0c238}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org1ad9cfb}]{SA Primitive Generators}
\end{frame}
\begin{frame}[label={sec:orgf892099}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org953c824}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orge81946a}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgca893b9}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgcb238b4}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org64b33e5}]{SA Wrapper Functions}
\end{frame}
\begin{frame}[label={sec:orgcdb233c}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgbe7cd0c}]{Charge Schedule Perturbation}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:org6ec7b37}]{SA Thesis Results}
\end{frame}
\begin{frame}[label={sec:org5e26939}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:org6c926e1}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgb02be25}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org7bc9aba}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5ca088e}]{Energy}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgd9489dc}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgd1b4ac8}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:orgd446513}]{References}
