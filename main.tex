...
\label{sec:org2d1dca4}
\begin{frame}[label={sec:orgff23564}]{Problem Description}
\begin{columns}
...
\begin{frame}[label={sec:orgbe87126}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:org884a22b}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org4145619}]{The Berth Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org0b5d7b5}]{The Berth Allocation Problem}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf47e94}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\label{sec:orgc44702c}
\begin{frame}[label={sec:orgc57cfa8}]{Requirements For BEB Implementation}
\begin{itemize}
...
\begin{frame}[label={sec:org5d320a5}]{Objective Function}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org0eab236}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc5f35a8}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
\item Used to ensure that individual rectangles do not overlap
...
\begin{frame}[label={sec:org0fb4a24}]{Packing Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org58a341d}]{Linear Battery Dynamic Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org983d978}]{Bilinear Linearization Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org151a823}]{Charging Queue Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org95f5285}]{Results}
\begin{itemize}
...
\begin{frame}[label={sec:orgcb3883c}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgc48aae0}]{Results}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgdeaf0c1}]{Results}
\begin{figure}[htpb]
\centering
...
\label{sec:orgac5eb47}
\begin{frame}[label={sec:orge099a4a}]{Simulated Annealing}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1a1a1cd}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgd600f48}]{Acceptance Criteria}
\begin{equation}
\label{eq:candaccept}
...
\begin{frame}[label={sec:orgefa1b64}]{Generation Mechanisms - Primitive Functions}
\begin{itemize}
...
\begin{frame}[label={sec:org9956c9e}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org2956a38}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orga463b9f}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orge68983d}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org9d73cf9}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orga31108b}]{Generation Mechanisms - Wrapper Functions}
\begin{itemize}
...
\begin{frame}[label={sec:orgd475f6f}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:org76fd1f2}]{Perturb Schedule}
\begin{center}
\scalebox{0.65}{
...
\begin{frame}[label={sec:org362ecad}]{Objective Function}
\begin{equation*}
...
\begin{frame}[label={sec:orga726b16}]{Constraints}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{equation*}
    \label{seq:c0}
...
\begin{frame}[label={sec:orga5fd254}]{Results - What Is In The Thesis}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:orgd2b5597}]{Schedule- What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org222edf5}]{Schedule - What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org51e16af}]{Charger Count - What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org86fda64}]{Charger Count - What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org7dd701d}]{Power - What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org7bcfd34}]{Energy - What Is In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgf30d550}]{What Happened?}
\begin{figure}[htpb]
\centering
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdbc5629}]{How To Resolve This Problem?}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org5a230d4}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:org0c18400}]{Results - What Is Not In The Thesis}
\begin{center}
\begin{tabular}{lrr}
\alert{Model} & \alert{Execution Time} [s] & \alert{Iteration} [s]\\[0pt]
\hline
...
\begin{frame}[label={sec:org9408b6a}]{Schedule - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org86f6158}]{Schedule - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgafcfe63}]{Charger Count - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1eb802c}]{Charger Count - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org1736973}]{Power - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org25d1429}]{Energy - What Is Not In The Thesis}
\begin{figure}[htpb]
\centering
...
\label{sec:org3c62169}
\begin{frame}[label={sec:orge2b667f}]{Introduction}
\begin{itemize}
\item Higher fidelity in approximating charge at high SOC
\item Implemented in SA for simplicity
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9e1d58d}]{Non-Linear Battery Dynamics Model}
\begin{itemize}
\item Show function
\item Show plots
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgff7dd2f}]{Results}
\begin{itemize}
\item Figures!
\end{itemize}
\end{frame}
