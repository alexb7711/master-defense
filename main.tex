...
\setbeamercolor{block title example}{fg=ForestGreen,bg=YellowGreen!60}
\setbeamercolor{block body example}{fg=black,bg=YellowGreen!50}
\setbeamercolor{example text}{fg=black}

\setbeamercolor{block title alerted}{fg=Blue,bg=SkyBlue!60}
\setbeamercolor{block body alerted}{fg=black,bg=SkyBlue!40}
\setbeamercolor{alerted text}{fg=black}

\section{Introduction}
\label{sec:org39fb31c}
\begin{frame}[label={sec:orgb2c8e57}]{}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:orgcd0a3ac}]{Problem Description}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\begin{tabular}{l|ccc}
Bus & Start [h] & Stop [h] & Discharge [kWh]\\[0pt]
\hline
1 & 1 & 1.5 & 50\\[0pt]
1 & 2 & 2.25 & 10\\[0pt]
2 & 0 & 0.75 & 15\\[0pt]
...
\begin{frame}[label={sec:org3a61eb8}]{Overall Objective}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org651bddf}]{Model Objectives - BPAP}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org95cdec1}]{Model Objectives - Linear SA}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgb3508fc}]{Brief State Of The Art}
{\scriptsize
\begin{center}
...
\begin{frame}[label={sec:org3db09d3}]{The Berth Allocation Problem\footnote{\url{https://www.mdpi.com/2077-1312/11/7/1280}}}
\begin{center}
\includegraphics[width=0.8\textwidth]{./img/berthing-sky-picture.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6e892eb}]{The Berth Allocation Problem}
\begin{columns}
...
\begin{frame}[label={sec:orgff2ee95}]{The Position Allocation Problem}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:orga263833}
\begin{frame}[label={sec:org7d9f017}]{}
\begin{block}{}
\begin{center}
\includegraphics[width=0.5\textwidth]{./img/pap.pdf}
\end{center}
\end{block}
...
\begin{frame}[label={sec:org37adde8}]{Requirements For BEB Implementation}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org4aa4c5f}]{Mixed Integer Linear Program}
\begin{equation*}
\label{eq:objective}
...
\begin{frame}[label={sec:org6508d3c}]{Queuing Constraints}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{equation*}
\colorboxed{blue}{
...
\begin{frame}[label={sec:orgc5b999a}]{Parameters}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{center}
\begin{tabular}{l|l}
...
\begin{frame}[label={sec:org6d6f6a4}]{Schedules}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org678b4db}]{SOC And Energy Use}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\label{sec:orgfe77c4b}
\begin{frame}[label={sec:org0c1dad3}]{}
\begin{block}{}
\begin{center}
...
\begin{frame}[label={sec:org952a0c1}]{Objective Function And Constraints}
\begin{equation*}
...
\begin{frame}[label={sec:orgc0f4ec3}]{Parameters}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgf1c0412}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org4e58a9c}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:org437a937}]{SOC and Energy}
\begin{columns}
...
\begin{frame}[label={sec:org85363de}]{Scores and Energy}
\begin{columns}
...
\label{sec:org7eab7f5}
\begin{frame}[label={sec:orgb83ada1}]{}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:orgc895fde}]{Summary}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:orgbc0d95f}]{Publications}
\begin{center}
\includegraphics[width=.9\linewidth]{./img/pub.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3dd2021}]{}
\centering
\Huge Questions?
\end{frame}

\appendix
\begin{frame}[label={sec:org551427b}]{}
\centering
\Huge Appendix
\end{frame}

\begin{frame}[label={sec:org2a0695c}]{Mixed Integer Linear Programming}
\begin{align*}
...
\begin{frame}[label={sec:orga2b384c}]{}
\centering
\Huge SA with Non-Linear Battery Dynamics
\end{frame}

\begin{frame}[label={sec:org75f0ae8}]{Introduction}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgaedd822}]{Non-Linear Battery Dynamics Model}
\begin{columns}
\begin{column}{0.3\columnwidth}
\begin{equation*}
...
\begin{frame}[label={sec:org3bb43ee}]{Results}
\begin{columns}
\begin{column}{0.5\columnwidth}
{\scriptsize
\begin{itemize}
...
\begin{frame}[label={sec:org4988ba0}]{}
\centering
\Huge Simulated Annealing
\end{frame}

\begin{frame}[label={sec:org9a422e3}]{Simulated Annealing\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1de673f}]{Cooling Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org96bd880}]{Acceptance Criteria\footnote{\url{https://en.wikipedia.org/wiki/Simulated\_annealing}}}
\begin{equation*}
\label{eq:candaccept}
...
\begin{frame}[label={sec:org6e8b016}]{Generation Mechanisms - Primitive Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org16982ba}]{Generation Mechanisms - Wrapper Functions}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc09e671}]{New Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:orgc2aad65}]{Slide Visit}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org383676b}]{New Charger}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org8f8c854}]{Wait}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgad7aacd}]{New Window}
\begin{algorithm}[H]
  \scriptsize
...
\begin{frame}[label={sec:org3fa0ab7}]{Charge Schedule Generation}
\begin{algorithm}[H]
\scriptsize
...
\begin{frame}[label={sec:orgcc9e0a4}]{Charge Schedule Perturbation}
\begin{algorithm}[H]
\tiny
...
\begin{frame}[label={sec:org7de380f}]{}
\centering
\Huge Thesis Results
\end{frame}

\begin{frame}[label={sec:org1335028}]{Parameters}
\begin{center}
\begin{tabular}{lrr}
...
\begin{frame}[label={sec:orgb347cf3}]{Schedule}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org44e2fcc}]{Power}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center} {\small \underline{Before}}\end{center}
...
\begin{frame}[label={sec:org49a89c6}]{Energy}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center} {\small \underline{Before}}\end{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2af72fc}]{Score Convergence Comparison}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
Before Fix
...
\begin{frame}[label={sec:orgf8b991b}]{How To Resolve This Problem?}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}[htpb]
\centering
...
\begin{frame}[label={sec:orgde694eb}]{References}
