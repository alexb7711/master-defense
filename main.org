...
** The Berth Allocation Problem :noexport:
*** Left
:PROPERTIES:
:BEAMER_col: 0.7
:END:
...
- PAP has more focus on slow chargers, but utilizes fast charger more readily than SA
#+latex: }
