...
#+startup: beamer
#+LaTeX_CLASS: beamer
#+LATEX_CLASS_OPTIONS: [aspectratio=169,dvipsnames]
...
#+latex:\setbeamercolor{block title example}{fg=ForestGreen,bg=YellowGreen!60}
#+latex:\setbeamercolor{block body example}{fg=black,bg=YellowGreen!50}
#+latex:\setbeamercolor{example text}{fg=black}

#+latex:\setbeamercolor{block title alerted}{fg=Blue,bg=SkyBlue!60}
#+latex:\setbeamercolor{block body alerted}{fg=black,bg=SkyBlue!40}
#+latex:\setbeamercolor{alerted text}{fg=black}

# +latex:\setbeamercolor{block title}{fg=Blue,bg=SkyBlue!70}
# +latex:\setbeamercolor{block body}{fg=black,bg=SkyBlue!50}
# +latex:\setbeamercolor{itemize item}{fg=black}
# +latex:\setbeamercolor{itemize subitem}{fg=black}
...
** Model Objectives - Non-linear SA :noexport:
:PROPERTIES:
:END:
...
**** SA PAP with Nonlinear Battery Dynamics
:PROPERTIES:
:BEAMER_env: alertblock
:END:
...
:BEAMER_col: 0.5
:END:
src_latex{\begin{center} {\small \underline{BPAP}}\end{center}}
...
src_latex{\begin{center} {\small \underline{SA Techniques}}\end{center}}
...
:BEAMER_col: 0.5
:END:
src_latex{\begin{center} {\small \underline{Before}}\end{center}}
...
src_latex{\begin{center} {\small \underline{After}}\end{center}}
